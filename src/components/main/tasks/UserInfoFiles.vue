<template>
  ...
  <div class="flex mr-[315px] justify-center items-center">
    <h1
        ...
        class="text-black text-[40px] font-bold text-center bg-lime-500 border-[3px] border-black rounded-lg py-2 px-[100px]">Hodim Vazifalari</h1>
  </div>

  <div class="flex absolute right-96 top-[275px] justify-end p-4">
...
const getFiles = async () => {
  ...
  try {
    ...
    files.value = response.data.userFiles.filter(file => file.type === "tasks");
  } catch (error) {
