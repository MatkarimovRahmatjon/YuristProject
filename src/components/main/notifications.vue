<template>
  <div class="text-black">
    ...
    <ul v-if="notifications.length">
      <li v-for="(notification, index) in notifications" :key="index" class="hover:shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)] hover:bg-lime-500 hover:-translate-y-1  duration-500 notification">
        {{ notification }}
