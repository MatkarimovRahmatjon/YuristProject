<script setup>
const menuItems = [
  { title: 'Sudlar royxati', route: '/courts' },
  { title: 'offering royxati', route: '/offering' },
  { title: 'map royxati', route: '/map' },
  { title: 'Partners', route: '/card' }
];
</script>
...
<template>
  <div class="flex text-black h-screen">
    <!-- Sidebar -->
    <div class="w-64 bg-gradient-to-b from-profile-blue to-profile-blue/95">
      <div class="py-6">
        <nav>
          <ul>
            <li v-for="item in menuItems" :key="item.route">
              <router-link
                  :to="item.route"
                  class="block px-8 py-4 text-[22px] hover:bg-white/10 transition-colors duration-200"
              >
                {{ item.title }}
              </router-link>
            </li>
...
<!--  <div class="flex flex-col text-white items-center mt-20 py-10">-->
...
<!--            class="relative hover:bg-lime-500 active:duration-500 bg-white border-4 border-blue-800 rounded-lg p-6">-->
